            ...
            <table class="min-w-full">
                <thead class="bg-blue-500">
                    <tr>
                        ...
                        <x-table.head>Spotify URL</x-table.head>
                ...
                <tbody class="divide-y divide-gray-200 divide-solid">
                    ...
                    <tr>
                        ...
                        <x-table.data>
                            <div>{{ $podcast->spotify_url }}</div>
                        </x-table.data>
                        <x-table.data>
                            <div class="flex justify-center space-x-4">

                                <a href="{{ route('admin.podcasts.edit', $podcast) }}" class="text-yellow-400">
                                    <x-zondicon-edit-pencil class="w-5 h-5" />
                                </a>

                                <x-form action="{{ route('admin.podcasts.destroy', $podcast) }}" method="DELETE">
